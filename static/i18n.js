...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_label_tps_chip: 'Show response speed in title bar',
    settings_desc_tps_chip: 'Shows the response speed counter while a reply is streaming. Stored in this browser only.',
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    settings_label_tps_chip: 'Показывать скорость ответа в строке заголовка',
    settings_desc_tps_chip: 'Показывает счётчик скорости ответа во время потоковой передачи. Сохраняется только в этом браузере.',
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    settings_label_tps_chip: 'Mostrar velocidad de respuesta en la barra de título',
    settings_desc_tps_chip: 'Muestra el contador de velocidad de respuesta mientras se transmite una respuesta. Se guarda solo en este navegador.',
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    settings_label_tps_chip: 'Antwortgeschwindigkeit in der Titelleiste anzeigen',
    settings_desc_tps_chip: 'Zeigt den Zähler für die Antwortgeschwindigkeit während des Streamings einer Antwort an. Wird nur in diesem Browser gespeichert.',
  ...
  folder_add_as_space_title: '\u6dfb\u52a0\u4e3a\u5de5\u4f5c\u533a\uff1f',
    ...
    settings_label_tps_chip: '在标题栏显示响应速度',
    settings_desc_tps_chip: '在回复流式传输时显示响应速度计数器。仅保存在此浏览器中。',
  ...
  ko: {
    ...
    settings_label_tps_chip: '제목 표시줄에 응답 속도 표시',
    settings_desc_tps_chip: '응답이 스트리밍되는 동안 응답 속도 카운터를 표시합니다. 이 브라우저에만 저장됩니다.',
